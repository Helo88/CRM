...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        // z-[60], not z-50 — see the matching note in components/ui/dialog.tsx:
        // StaffSidebar.tsx's persistent nav rail is a fixed z-50 element too.
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        data-side={side}
        className={cn(
          // Note: "left"/"right" here mean the logical START/END edge (not
          // physical), so the drawer always opens from the reading-start
          // side in both LTR and RTL locales — matches StaffSidebar's own
          // start-0/border-e convention.
